...
contract VOYR_Token is Context, IERC20, Ownable {
    ...
    uint256 private constant _presaleUnlockPrice = 50000000000000000;  // This is 0.05 BNB
    uint256 private constant _presaleMinimum = 100000000000000000;  // This is 0.1 BNB - must include 18 zeroes
    uint256 private constant _presaleMaximum = 25000000000000000000;  // This is 20 BNB - must include 18 zeroes
    uint256 private constant _tokenPerBNB = 9000000;  //10,000,000
    ...
    address public _previousOperationsWallet;
    address public charityWallet;
    address public _previousCharityWallet;
...
|_______/    /__/     \__\ |__|     |_______||_______/    /__/     \__\ |_______||_______|
    ...
    */
    ...
    function setOperationsFeePercent(uint256 operationsFee) external onlyOwner() {
        ...
        emit FeeChanged("OperationsFee", _previousOperationsFee, _operationsFee);
    }
    ...
    function setOperationsWallet(address _operationsWallet) external onlyOwner() {
        _previousOperationsWallet = operationsWallet;
        operationsWallet = _operationsWallet;
        _isExcluded[operationsWallet] = true;
        emit WalletChanged("OperationsWallet", _previousOperationsWallet, operationsWallet);
    }
    ...
    function setCharityFeePercent(uint256 charityFee) external onlyOwner() {
        ...
        emit FeeChanged("CharityFee", _previousCharityFee, _charityFee);
    }
    ...
    function setCharityWallet(address _charityWallet) external onlyOwner() {
        _previousCharityWallet = charityWallet;
        charityWallet = _charityWallet;
        _isExcluded[charityWallet] = true;
        emit WalletChanged("CharityWallet", _previousCharityWallet, charityWallet);
    }
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256 tTransferAmount, uint256 tFee, uint256 tLiquidity, uint256 tOperations, uint256 tCharity) {
        ...
        tOperations= tAmount.mul(_operationsFee).div(10**2);
        tCharity = tAmount.mul(_charityFee).div(10**2);
